...
export const LogIn = () => {
    ...
    <form className="modal-content" >
        <div className="container pt-3" style={{border:0}}>
            <h2>Enter details to log in</h2>

            <div className="row">
                <div className="col-4"></div>
                <div className="col-4 px-5" style={{border: "2px solid black", backgroundColor:  "rgb(198, 171, 152)" ,textAlign: "center"}}>
                    ...
                    <div className="container mb-2" style={{border:0}}>
                        <button style={{width: "200px", backgroundColor: "rgb(140, 99, 49)"}}><b>Log In</b></button> 
                        <br/><a href="/signup">If you are a new use, click here!</a>
                    </div>
